...
##    0.001s ( 10%) Column type detection (first, middle and last 5 rows)
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in forder(x, -n): Column '1' is type 'closure' which is not supported for ordering currently.}}\end{kframe}
\end{knitrout}
